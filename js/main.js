...
/*properties
    ...
    activeElement, addEventListener, add_content_if_needed, altKey, amount, 
    app_name, appendChild, attach, b, body, books_long_main, 
    books_long_posttitle, books_long_pretitle, books_short, bottom_book, 
    bottom_id, bottom_verse, c, changeCSS, chapter, chapter_count, charCodeAt, 
    childNodes, chrome, className, clearInterval, clearTimeout, clear_scroll, 
    clientHeight, createElement, createTextNode, create_verse_id, 
    create_viewport, cssRules, cssText, cssTransitions, ctrlKey, detach, 
    determine_reference, direction, documentElement, encodeURIComponent, event, 
    firstChild, focus, format_number, full_book, full_verse, get, 
    getElementById, get_b_c_v, get_position, grammar_keywords, grammar_marker, 
    grammar_marker_len, grammar_separator, height, highlight, i, id, 
    in_paragraphs, include, initial_query, innerHTML, insertBefore, insertRule, 
    is_WebKit, is_busy, is_object, keyCode, lang, lastChild, left, line_height, 
    metaKey, n, navigator, new_val, nextSibling, offsetHeight, offsetLeft, 
    ...
    parseInt, parse_json, prepare_highlighter, prepare_search, preventDefault, 
    previousSibling, properties, psalm, psalm_has_title, query, 
    query_additional, query_explanation, query_previous, query_type, raw_query, 
    reached_bottom, reached_top, readyState, red_letters, remove, removeChild, 
    replace, responseText, round, rules, scrollBy, scrollHeight, scrollTo, 
    scroll_to_verse, scroll_view_to, selectorText, send, set, setInterval, 
    setRequestHeader, setTimeout, settings, split, standard_terms, start_at, 
    status, stopPropagation, style, styleSheets, subscription, system, t, 
    tagName, title, top, topBar, topBar_height, top_id, top_verse, trigger, 
