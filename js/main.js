...
/*properties
    ...
    prepare_search, preventDefault, previousSibling, properties, psalm, 
    psalm_has_title, query, query_additional, query_explanation, 
    query_previous, query_type, raw_query, reached_bottom, reached_top, 
    readyState, red_letters, removeChild, replace, responseText, round, rules, 
    scrollBy, scrollHeight, scrollTo, scroll_to_verse, scroll_view_to, 
    selectorText, send, set, setInterval, setRequestHeader, setTimeout, 
    settings, split, standard_terms, start_at, status, style, styleSheets, 
    subscription, system, t, tagName, title, top, topBar, topBar_height, 
    top_id, top_verse, type, update_verse_range, userAgent, v, value, verse, 
