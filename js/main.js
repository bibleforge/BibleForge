...
/*properties
    ...
    activeElement, addEventListener, add_content_if_needed, additional, alt, 
    altKey, amount, app_name, appendChild, apply, attach, b, base_query, body, 
    books_long_main, books_long_posttitle, books_long_pretitle, books_short, 
    bottom_book, bottom_id, bottom_verse, c, changeCSS, change_language, chapter, 
    chapter_count, childNodes, chrome, className, clearInterval, clearTimeout, 
    clear_scroll, clientHeight, configurable, consts, content_manager, 
    createElement, createTextNode, create_verse_id, create_viewport, cssRules, 
    cssText, cssTransitions, ctrl, ctrlKey, decodeURIComponent, defineProperty, 
    detach, determine_reference, direction, documentElement, en, 
    encodeURIComponent, enumerable, event, extra_highlighting, firstChild, focus, 
    format_number, full_book, full_verse, get, getElementById, 
    getElementsByTagName, getItem, getState, get_b_c_v, get_position, 
    grammar_keywords, grammar_marker, grammar_marker_len, grammar_separator, 
    grammatical_search, hasOwnProperty, height, highlight, history, i, id, 
    in_paragraphs, include, indexOf, indicate_loading, initial_page_load, 
    initial_query, innerHTML, insertBefore, insertRule, is_WebKit, is_busy, 
    is_default, is_object, join, keyCode, keyboard_busy, keys_pressed, lang, 
    langEl, lang_id, langs, lastChild, last_query, left, length, line_height, 
    localStorage, location, map, metaKey, mixed_search, n, navigator, new_val, 
    nextSibling, no_results1, no_results2, offsetHeight, offsetLeft, 
    ...
    pageYOffset, parentNode, parse, parseInt, parse_json, pathname, position, 
    preload_font, prepare_highlighter, prepare_query, prepared_query, prev_lang, 
...
(function ()
{
    ...
    BF.create_viewport = function (viewPort, doc_docEl)
    {
        ...
        (function ()
        {
            ...
            window.setTimeout(function ()
            {
                BF.include("/js/secondary.js?10176708", {
