...
/*properties
    ...
    clientHeight, content_manager, createElement, createTextNode, 
    create_verse_id, create_viewport, cssRules, cssText, cssTransitions, 
    ctrlKey, detach, determine_reference, direction, documentElement, en, 
    encodeURIComponent, event, firstChild, focus, format_number, full_book, 
    full_verse, get, getElementById, get_b_c_v, get_position, grammar_keywords, 
    grammar_marker, grammar_marker_len, grammar_separator, height, highlight, 
    i, id, in_paragraphs, include, initial_query, innerHTML, insertBefore, 
    insertRule, is_WebKit, is_busy, is_object, keyCode, lang, langEl, lang_id, 
    langs, lastChild, left, line_height, metaKey, n, navigator, new_val, 
    nextSibling, offsetHeight, offsetLeft, offsetParent, offsetTop, old_val, 
    onblur, onfocus, onreadystatechange, onsubmit, open, opera, p, page, 
    pageXOffset, pageYOffset, parentNode, parseInt, parse_json, 
    prepare_highlighter, prepare_search, preventDefault, previousSibling, 
    properties, psalm, psalm_has_title, qEl, query, query_additional, 
    query_explanation, query_previous, query_type, raw_query, reached_bottom, 
    reached_top, readyState, red_letters, remove, removeChild, replace, 
    responseText, round, rules, scrollBy, scrollHeight, scrollTo, 
