...
/*properties
    ...
    amount, app_name, appendChild, apply, attach, b, base_query, body, 
    books_long_main, books_long_posttitle, books_long_pretitle, books_short, 
    bottom_book, bottom_id, bottom_verse, c, changeCSS, change_language, 
    chapter, chapter_count, childNodes, chrome, className, clearInterval, 
    ...
    lastChild, last_query, left, length, line_height, localStorage, location, 
    map, metaKey, n, navigator, needsHash, new_val, nextSibling, no_results1, 
    no_results2, offsetHeight, offsetLeft, offsetParent, offsetTop, old_val, 
    onblur, onfocus, onreadystatechange, onsubmit, open, opera, options, 
    originalTarget, p, page, pageXOffset, pageYOffset, parentNode, parse, 
    parseInt, parse_json, pathname, position, preload_font, 
    ...
    system, t, tagName, test, textContent, title, toggleCSS, top, topBar, 
    topBar_height, top_id, top_verse, trigger, trim, type, update_verse_range, 
    user, userAgent, v, value, verse, verse_id, verse_range, view, 
    viewPort_count, viewPort_num, visibility, webkitTransition
*/
