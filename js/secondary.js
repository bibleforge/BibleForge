...
/*properties
    ...
    checked, childNodes, className, clearTimeout, clear_scroll, clientWidth, 
    configure, content_manager, createElement, createTextNode, cssText, 
    cssTransitions, ctrlKey, currentTarget, destroy, detail, display, done, 
    event, full_name, get, getElementById, get_position, height, help, href, 
    htmlFor, id, identifier, include, innerHTML, innerHeight, innerWidth, 
    insertBefore, insertCell, insertRow, is_WebKit, italics_explanation, 
    just_created, lang, langEl, langs, left, length, line, line_height, link, 
    linked_to_orig, lit, loaded, long_def, maxHeight, maxWidth, move, name, 
    ...
    parentNode, parse_json, pinned, point_to_el_exists, prev_lang, 
