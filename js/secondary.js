...
/*properties
    ...
    maxWidth, modified, move, name, nodeName, offsetHeight, offsetLeft, 
    ...
    pageXOffset, pageYOffset, paragraphs, parentNode, parse_json, pinned, 
    point_to_el_exists, prev_lang, preventDefault, pronunciation, properties, 
    pushState, qEl, query, real_query, red_letters, relatedTarget, remove, 
