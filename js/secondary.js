...
/*properties
    ...
    amount, appendChild, attach, blog, body, borderTop, button, checked, 
    childNodes, className, clearTimeout, clear_scroll, clientWidth, configure, 
    content_manager, createElement, createTextNode, cssText, cssTransitions, 
    ctrlKey, currentTarget, destroy, detail, display, done, event, full_name, 
    get, getElementById, get_position, height, help, href, htmlFor, id, 
    identifier, include, innerHTML, innerHeight, innerWidth, insertBefore, 
    insertCell, insertRow, is_WebKit, italics_explanation, just_created, lang, 
    langEl, langs, left, length, line, line_height, link, linked_to_orig, lit, 
    loaded, long_def, maxHeight, maxWidth, move, name, nodeName, offsetHeight, 
    offsetLeft, offsetTop, offsetWidth, onchange, onclick, onfocus, 
    onmousemove, onmouseout, opacity, options, originalTarget, paddingLeft, 
    page, pageXOffset, pageYOffset, paragraphs, parentNode, parse_json, pinned, 
    point_to_el_exists, prev_lang, preventDefault, pronunciation, properties, 
    qEl, query, red_letters, relatedTarget, removeChild, removeEventListener, 
    replace_HTML, scrollBy, set, setTimeout, settings, short_def, short_name, 
    src, srcElement, stopPropagation, style, system, tagName, target, text, 
    title, toggleCSS, top, topBar, topBar_height, trigger, type, value, view, 
