...
/*properties
    ...
    amount, appendChild, attach, blog, body, books_short, borderTop, button, 
    change_language, checked, childNodes, className, clearTimeout, 
    clear_scroll, clientWidth, configure, content_manager, createElement, 
    createTextNode, cssText, cssTransitions, ctrlKey, currentTarget, destroy, 
    detail, display, done, event, full_name, get, getElementById, get_position, 
    height, help, href, htmlFor, id, identifier, include, innerHTML, 
    innerHeight, innerWidth, insertBefore, insertCell, insertRow, is_WebKit, 
    italics_explanation, just_created, lang, langEl, langs, left, length, line, 
    ...
    options, originalTarget, paddingLeft, page, pageXOffset, pageYOffset, 
    paragraphs, parentNode, parse_json, pinned, point_to_el_exists, prev_lang, 
    preventDefault, pronunciation, properties, qEl, query, query_explanation, 
    red_letters, relatedTarget, removeChild, removeEventListener, replace_HTML, 
    run_new_query, scrollBy, set, setTimeout, settings, short_def, short_name, 
