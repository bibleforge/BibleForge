...
/*properties
    ...
    cssText, cssTransitions, ctrl, ctrlKey, currentTarget, destroy, detail, 
    dispatchEvent, display, done, encodeURIComponent, event, full_name, 
    getClientRects, getElementById, get_position, get_query_info, 
    hasOwnProperty, height, help, history, href, htmlFor, id, identifier, 
    include, indicate_loading, initMouseEvent, innerHTML, innerHeight, 
    innerWidth, insertBefore, insertCell, insertRow, is_WebKit, 
    ...
    move, name, nodeName, offsetHeight, offsetLeft, offsetTop, offsetWidth, 
    onchange, onclick, onfocus, onmousemove, onmouseout, opacity, open, 
    options, originalTarget, paddingLeft, page, pageXOffset, pageYOffset, 
    paragraphs, parentNode, parse_json, pinned, point_to_el_exists, 
    preload_font, prev_lang, preventDefault, pronunciation, properties, 
    pushState, qEl, query, query_explanation, real_query, red_letters, 
    ...
    target, text, title, toggleCSS, top, topBar, topBar_height, trigger, trim, 
    type, value, view, viewPort_num, visibility, wheelDelta, which_rect, width, 
    word, wrench_title
*/
