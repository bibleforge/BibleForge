...
/*properties
    ...
    include, innerHTML, innerHeight, innerWidth, insertBefore, insertCell, 
    insertRow, is_WebKit, italics_explanation, just_created, lang, langEl, 
    langs, left, length, line, line_height, link, linked_to_orig, lit, loaded, 
    long_def, maxHeight, maxWidth, modified, move, name, nodeName, 
    offsetHeight, offsetLeft, offsetTop, offsetWidth, onchange, onclick, 
    onfocus, onmousemove, onmouseout, opacity, options, originalTarget, 
    ...
    pronunciation, properties, pushState, qEl, query, raw_query, red_letters, 
