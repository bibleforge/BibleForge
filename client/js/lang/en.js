...
first_loop:     for (i = 0; i < arr_len; i += 1) {
        ...
        {
            /// Book Regex
            ///NOTE: Created in the Forge via create_reference_regex.php on 07-18-2012 from ref_array_en.php.
