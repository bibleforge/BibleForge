...
/*properties
    Create_easy_ajax, abort, about, absolute, addEventListener, add_property, 
    align_callout, alt, amount, appendChild, attach, b, biblical, biblical_ipa, 
    biblical_ipa_long, biblical_pronun, blog, body, books_short, bottom, button, 
    ...
    content_manager, createDocumentFragment, createElement, createEvent, 
    createTextNode, cssTransitions, ctrl, ctrlKey, currentTarget, data, def, 
    destroy, detach, detail, details, dic, dic_mod, dispatchEvent, display, done, 
    encodeURIComponent, event, full_name, getClientRects, getElementById, 
    get_position, hasOwnProperty, height, help, history, href, html, htmlFor, id, 
    include, indicate_loading, initMouseEvent, innerHTML, innerHeight, 
    innerWidth, insertBefore, insertCell, insertRow, ipa, ipa_mod, is_WebKit, 
    is_default, italics_explanation, just_created, keyCode, keyboard_busy, 
    keys_pressed, lang, langEl, langs, last_query, left, length, lexical_lookup, 
    line, line_height, link, linked_to_orig, lit, loaded, maxHeight, maxWidth, 
    modern, modern_ipa, modern_pronun, modified, mouse_x, mouse_y, move, 
    nodeName, offsetHeight, offsetWidth, onchange, onclick, onfocus, onmousemove, 
    ...
    translit, translit_long, trigger, trim, type, user, v, value, verse_lookup, 
    viewPort_num, visibility, wheelDelta, which_rect, width, word, wrench_title, 
    x, y
*/
