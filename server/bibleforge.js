                                ...
                                if (!data || !data.length) {
                                    ...
                                    back_next = (function ()
                                    {
                                        ...
                                        if (b !== 1 || c !== 1) {
                                            ...
                                            res += "<a class=\"static_link prev\" href=\"/" + lang.id + "/" + lang.books_short[prev_b] + "%20" + prev_c + "/!" + "\">&lt; " + (prev_b === 19 ? lang.previous_psalm : lang.previous_chap) + "</a>";
                                        }
                                        ...
                                        if (b !== 66 || c !== lang.chapter_count[66]) {
                                            ...
                                            ///NOTE: Psalms uses a special name (i.e., "psalm" instead of "chapter").
                                            res += "<a class=\"static_link next\" href=\"/" + lang.id + "/" + lang.books_short[next_b] + "%20" + next_c + "/!" + "\">" + (next_b === 19 ? lang.next_psalm : lang.next_chap) + " &gt;</a>";
                                        }
